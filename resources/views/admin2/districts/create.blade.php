    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 style="color: #11304e">Add City</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header" style="background: #11304e;">
                                <h3 class="card-title">Add City <small></small></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                                ...
                                <div class="card-body" style="color: #11304e;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="card-footer">
                                            <button style="background: #11304e; border: none;" type="submit"
                                                class="btn btn-primary">Add Districts</button>
                                        </div>
                            </form>
                        </div>
                        <!-- /.card -->
