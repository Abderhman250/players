                            ...
                            <div class="card-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @if($appointments->user_id ==  Auth::user()->id || Auth::user()->role_id == 1 )
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if (!empty($appointments->reservation->Doctor->name))
                                                        {{ $appointments->reservation->Doctor->name }}
                                                    @else
                                                        <span style="text-align:center;">_</span>
                                                    @endif
                                                </td>
                                                <td>
                                                  @if (!empty($appointments->User->name))
                                                ...
                                                <td>
                                                    ...
                                                    @if (!empty($appointments->reservation->start))
                                                        {{ $appointments->reservation->start }}
                                                    @else
                                                        <span style="text-align:center;">_</span>
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    @if (!empty($appointments->reservation->end))
                                                        {{ $appointments->reservation->end }}
                                                    @else
                                                        <span style="text-align:center;">_</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    ...
                                                    @if (!empty($appointments->reservation->date))
                                                        {{ $appointments->reservation->date }}
                                                    @else
                                                        <span style="text-align:center;">_</span>
                                                    @endif
                                                </td>
                                                ...
                                                <td style="text-align:center;">
                                                    ...
                                                    {{-- <a style="background: #1f466b;border: #1f466b;" href="{{ route('reservations.edit', $reservation->id) }}" class="btn btn-small btn-info">
