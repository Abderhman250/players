...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 style="color: #11304e">Update User</h1>
        </div>
        <div class="col-sm-6">
...
{{-- 
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <input type="text" name="scout" class="form-control" id="exampleInputEmail1" placeholder="Enter Scout" value="{{ $user->scout }}">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="card-footer">
        <button style="background: #07b690; border: none;" type="submit" class="btn btn-primary">Update User</button>
      </div>
    </form>
  </div>
  <!-- /.card -->
